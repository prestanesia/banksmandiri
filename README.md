...
--------
Modul pembayaran Bank Syariah Mandiri untuk PrestaShop 1.6.x (branch: 1.6) dan PrestaShop 1.7.x (branch: master)
...
* Rename banksmandiri-master.zip menjadi banksmandiri.zip
